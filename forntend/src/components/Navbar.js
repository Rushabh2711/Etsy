    ...
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="static" color='transparent'>
        <Toolbar>
          ...
          {user ? <Button variant="outlined" style={{backgroundColor: "#000000", color: "#ffffff"}} size="small" onClick={handleLoginClick}>Login</Button> : <IconButton
                  size="large"
                  edge="end"
      ...
      <Registration open={openRegistration} handleClose={handleRegistrationClose}/>
    </Box>
  );
}
